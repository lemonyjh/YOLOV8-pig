...
from login.ultralytics.yolo.data.augment import LetterBox
from login.ultralytics.yolo.utils import LOGGER, SimpleClass, deprecation_warn, ops
from login.ultralytics.yolo.utils.plotting import Annotator, colors
...
class Results(SimpleClass):
    ...
    def __init__(self, orig_img, path, names, labels, boxes=None, masks=None, probs=None, keypoints=None) -> None:
