    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil :
            ...
            if label:
                ...
                p2 = p1[0] + int(w/1.5), p1[1] - h - 3 if outside else p1[1] + h + 3
                ...
                #中文书写
                img = Image.fromarray(cv2.cvtColor(self.im, cv2.COLOR_BGR2RGB))
                draw = ImageDraw.Draw(img)
                fontText = ImageFont.truetype('simsun.ttc', 30, encoding="utf-8")
                fontText.weight = 'bold'
                draw.text((p1[0], p1[1] - 25 ), label, txt_color, font=fontText)
                # img.save(r'D:\yolov8\ultralytics-main/123.jpg')
                self.im = cv2.cvtColor(numpy.asarray(img), cv2.COLOR_RGB2BGR)
