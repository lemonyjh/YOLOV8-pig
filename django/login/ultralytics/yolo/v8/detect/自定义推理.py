...
class BasePredictor:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.labelcc = {'prone':["趴卧",0], 'stand':["站立",0],'lateral':["侧卧",0],'bin_empty':["食槽无料",0], 'bin_feed':["食槽有料",0], 'bin_unkown':["食槽未知",0]}
    ...
    def postprocess(self, preds, img, orig_imgs):
        ...
        for i, pred in enumerate(preds):
            ...
            #书写标签的位置“Results”
            results.append(Results(orig_img=orig_img, path=img_path, names=self.model.names, boxes=pred,labels=self.labelcc))
        return results
